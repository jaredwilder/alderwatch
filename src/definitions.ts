...
export const RECIPES:Recipe[]=[
 ...
 {id:'hare_pottage',name:'Hare & mushroom pottage',cost:{hare_meat:1,mushroom:1,herb:1,wood:1},station:'campfire',output:'hare_pottage',count:1,description:'A deep woodland pot. +15 health and +30 stamina for 8 minutes; restores 28 health.'},
 {id:'crow_blackpot',name:'Blackpot crow',cost:{crow_meat:1,mushroom:1,berries:1,wood:1},station:'campfire',output:'crow_blackpot',count:1,description:'Crow, berries, and mushrooms cooked dark. +10 health and +35 stamina for 7 minutes; restores 20 health.'},
 {id:'goat_stew',name:'Goatberry stew',cost:{goat_meat:1,mushroom:1,berries:1,herb:1,wood:1},station:'campfire',output:'goat_stew',count:1,description:'A thick goat stew. +30 health and +20 stamina for 10 minutes; restores 30 health.'},
 {id:'mutton_stew',name:'Shepherd’s mutton pot',cost:{mutton:1,mushroom:1,herb:1,wood:1},station:'campfire',output:'mutton_stew',count:1,description:'A rich shepherd’s pot. +40 health and +10 stamina for 10 minutes; restores 35 health.'},
 {id:'venison_berry_roast',name:'Berry-glazed venison',cost:{venison:1,berries:2,wild_honey:1,wood:1},station:'campfire',output:'venison_berry_roast',count:1,description:'Honeyed venison with wild berries. +30 health and +30 stamina for 10 minutes; restores 32 health.'},
 {id:'bear_pottage',name:'Bear & mushroom pottage',cost:{bear_meat:1,mushroom:2,herb:1,wood:2},station:'campfire',output:'bear_pottage',count:1,description:'Heavy woodland fare. +50 health and +15 stamina for 12 minutes; restores 40 health.'},
 {id:'bison_stew',name:'Bison trail stew',cost:{bison_meat:1,mushroom:1,berries:2,herb:1,wood:2},station:'campfire',output:'bison_stew',count:1,description:'A huge trail stew. +40 health and +40 stamina for 12 minutes; restores 40 health.'},
 {id:'wolf_broth',name:'Blackwood wolf broth',cost:{wolf_meat:1,mushroom:1,herb:1,wood:2},station:'campfire',output:'wolf_broth',count:1,description:'Hard-smoked wolf in herb broth. +10 health and +55 stamina for 12 minutes; restores 24 health.'},
 {id:'eagle_broth',name:'Highland eagle broth',cost:{eagle_meat:1,mushroom:1,herb:1,wood:1},station:'campfire',output:'eagle_broth',count:1,description:'A light highland broth. +20 health and +50 stamina for 12 minutes; restores 26 health.'},

 {id:'hunter_platter',name:'Hunter’s platter',cost:{hare_meat:1,venison:1,eagle_meat:1,berries:2,herb:1,wood:2},station:'campfire',output:'hunter_platter',count:1,description:'Hare, venison, eagle, and berries. +45 health and +55 stamina for 15 minutes; restores 45 health.'},
 {id:'frontier_mixed_grill',name:'Frontier mixed grill',cost:{goat_meat:1,mutton:1,bison_meat:1,herb:2,wood:2},station:'campfire',output:'frontier_mixed_grill',count:1,description:'Goat, mutton, and bison over a hard fire. +60 health and +45 stamina for 15 minutes; restores 50 health.'},
 {id:'predator_stew',name:'Blackwood predator stew',cost:{bear_meat:1,wolf_meat:1,mushroom:2,wild_honey:1,wood:2},station:'campfire',output:'predator_stew',count:1,description:'Bear and wolf with mushroom and honey. +55 health and +60 stamina for 15 minutes; restores 55 health.'},

 {id:'moonlit_hare',name:'Moonlit hare saddle',cost:{hare_saddle:1,wild_honey:1,herb:2,wood:1},station:'campfire',output:'moonlit_hare',count:1,description:'Rare feast. +35 health and +65 stamina for 20 minutes; restores 45 health.'},
 {id:'blackwing_roast',name:'Blackwing honey roast',cost:{crow_breast:1,wild_honey:1,berries:1,wood:1},station:'campfire',output:'blackwing_roast',count:1,description:'Rare feast. +25 health and +70 stamina for 18 minutes; restores 38 health.'},
 {id:'highland_goat_roast',name:'Highland tenderloin roast',cost:{goat_tenderloin:1,wild_honey:1,herb:2,wood:2},station:'campfire',output:'highland_goat_roast',count:1,description:'Rare feast. +60 health and +50 stamina for 20 minutes; restores 55 health.'},
 {id:'golden_mutton_rack',name:'Golden mutton rack',cost:{mutton_rack:1,wild_honey:1,herb:2,wood:2},station:'campfire',output:'golden_mutton_rack',count:1,description:'Rare feast. +70 health and +35 stamina for 20 minutes; restores 65 health.'},
 {id:'kings_hart',name:'King’s hart plate',cost:{hart_tenderloin:1,wild_honey:1,berries:2,herb:1,wood:2},station:'campfire',output:'kings_hart',count:1,description:'Rare feast. +60 health and +60 stamina for 20 minutes; restores 65 health.'},
 {id:'old_bear_rib',name:'Old-bear honey rib',cost:{bear_rib:1,wild_honey:1,mushroom:2,herb:1,wood:2},station:'campfire',output:'old_bear_rib',count:1,description:'Rare feast. +75 health and +30 stamina for 20 minutes; restores 75 health.'},
 {id:'great_bison_feast',name:'Great bison feast',cost:{bison_hump:1,wild_honey:1,berries:2,herb:2,wood:2},station:'campfire',output:'great_bison_feast',count:1,description:'Rare feast. +65 health and +65 stamina for 20 minutes; restores 75 health.'},
 {id:'night_wolf_loin',name:'Night-wolf loin roast',cost:{wolf_loin:1,wild_honey:1,mushroom:1,herb:2,wood:2},station:'campfire',output:'night_wolf_loin',count:1,description:'Rare feast. +30 health and +75 stamina for 20 minutes; restores 50 health.'},
 {id:'eagle_crown_roast',name:'Eagle-crown roast',cost:{eagle_breast:1,wild_honey:1,berries:1,herb:2,wood:1},station:'campfire',output:'eagle_crown_roast',count:1,description:'Rare feast. +45 health and +70 stamina for 20 minutes; restores 55 health.'},
];
