...
import {HOUSEHOLDS_PER_SHARD,describeHousehold,householdName,type SocialFaction} from './realm-society';
...
export class CrownroadResidentPopulation{
 ...
 constructor(private parent:T.Group,private assets:Assets,public world:WorldState){this.root.name='Crownroad bounded resident bubble';parent.add(this.root);}
 ...
 private clear(){for(const r of this.runtimes)r.mixer?.stopAllAction();this.runtimes.length=0;this.root.clear();}
