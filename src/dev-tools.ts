...
function install(){
 ...
 panel.innerHTML='<header><strong>ALDERWATCH DEV TOOLS</strong><span class="aw-dev-badge">F2 · CLICK DEV</span></header><section><div class="aw-dev-state"></div></section><section><div class="aw-dev-grid"><button data-cmd="tp ironward">TP · Ironward gate</button><button data-cmd="travel crossing">Travel · Crossing</button><button data-cmd="travel basin">Travel · Basin</button><button data-cmd="travel mine">Travel · Deep Iron</button><button data-cmd="travel crownroad">Travel · Crownroad</button><button data-cmd="travel greyhaven">Jump · Greyhaven</button><button data-cmd="travel march">Return · Far March</button><button data-cmd="heal">Heal / stamina</button><button data-cmd="reload">Reload area</button></div></section><section><div class="aw-dev-command"><input spellcheck="false" placeholder="status | travel greyhaven | give iron 99"><button>RUN</button></div><div class="aw-dev-log"></div></section>';
