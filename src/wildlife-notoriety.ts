...
export function animalDisplayName(a:AnimalState){ensureAnimalNotoriety(a);const kind=a.kind[0].toUpperCase()+a.kind.slice(1),earnedName=(a.notoriety??0)>=WANTED_NOTORIETY||!!a.epithet;return earnedName?`${kind}, ${animalEpithet(a)}`:kind;}
