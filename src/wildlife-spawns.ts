...
export const WILDLIFE_SPAWNS:readonly WildlifeSpawn[]=[
 ...
 {id:'pasture-goat-5',kind:'goat',x:27,z:22,yaw:5.3},{id:'pasture-goat-6',kind:'goat',x:31,z:29,yaw:.9},{id:'pasture-goat-7',kind:'goat',x:28,z:36,yaw:2.8},{id:'pasture-goat-8',kind:'goat',x:8,z:43,yaw:4.0},{id:'pasture-goat-9',kind:'goat',x:24,z:44,yaw:1.6},
 ...
 {id:'pasture-sheep-5',kind:'sheep',x:-29,z:19,yaw:.5},{id:'pasture-sheep-6',kind:'sheep',x:-32,z:27,yaw:4.9},{id:'pasture-sheep-7',kind:'sheep',x:-30,z:36,yaw:2.7},{id:'pasture-sheep-8',kind:'sheep',x:-10,z:44,yaw:1.0},{id:'pasture-sheep-9',kind:'sheep',x:-25,z:43,yaw:3.8},
