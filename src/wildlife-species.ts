...
export const WILDLIFE_SPECIES:Record<AnimalKind,WildlifeSpecies>={
 ...
 sheep:{authored:true,legacyFallback:true,modelHeight:.95,aimHeight:.62,deathRoll:1.18,maxHealth:46,loot:{mutton:2,hide:2},rareLoot:{item:'mutton_rack',count:1,oneIn:8},herd:true,grazes:false,fleeRadius:8,homeRadius:13,wanderSpeed:.56,escapeSpeed:3.5,turnRate:4.8},
