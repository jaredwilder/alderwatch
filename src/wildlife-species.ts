...
export const WILDLIFE_SPECIES:Record<AnimalKind,WildlifeSpecies>={
 hare:{authored:false,aimHeight:.28,deathRoll:1.18,maxHealth:18,loot:{hare_meat:1},herd:false,grazes:false,fleeRadius:6,homeRadius:8,wanderSpeed:.6,escapeSpeed:3.8,turnRate:4.8},
 crow:{authored:false,aimHeight:.25,deathRoll:1.18,maxHealth:10,loot:{crow_meat:1,crow_crop:1},herd:false,grazes:false,fleeRadius:6,homeRadius:8,wanderSpeed:.6,escapeSpeed:3.8,turnRate:4.8},
 goat:{authored:true,modelHeight:.9,aimHeight:.62,deathRoll:1.18,maxHealth:52,loot:{goat_meat:2,hide:1},herd:true,grazes:false,fleeRadius:7.5,homeRadius:13,wanderSpeed:.62,escapeSpeed:3.6,turnRate:4.8},
 sheep:{authored:true,modelHeight:.95,aimHeight:.62,deathRoll:1.18,maxHealth:46,loot:{mutton:2,hide:2},herd:true,grazes:false,fleeRadius:8,homeRadius:13,wanderSpeed:.56,escapeSpeed:3.5,turnRate:4.8},
 ...
 bear:{authored:true,modelHeight:1.65,aimHeight:1,deathRoll:.72,maxHealth:180,loot:{bear_meat:6,hide:5},herd:false,grazes:false,fleeRadius:0,homeRadius:38,wanderSpeed:.72,escapeSpeed:1.8,turnRate:2.5,predator:{prey:['hare','goat','sheep','deer','bison','wolf','eagle'],acquireRadius:25,chaseSpeed:4.1,attackReach:1.75,attackCooldown:72,preyDamage:24,playerAggroRadius:6.5,provokedRadius:34,playerDamage:26,blockedDamage:6,guardStaminaCost:20}},
 bison:{authored:true,modelHeight:1.9,aimHeight:1.15,deathRoll:1.05,maxHealth:240,loot:{bison_meat:8,hide:6},herd:true,grazes:true,fleeRadius:4.5,homeRadius:30,wanderSpeed:.52,escapeSpeed:4.8,turnRate:3.2},
 wolf:{authored:true,modelHeight:1.05,aimHeight:.58,deathRoll:1.08,maxHealth:74,loot:{wolf_meat:2,hide:1},herd:true,grazes:false,fleeRadius:0,homeRadius:34,wanderSpeed:.72,escapeSpeed:5.2,turnRate:5.4,predator:{prey:['hare','goat','sheep','deer','bison','eagle'],acquireRadius:42,chaseSpeed:5.35,attackReach:1.55,attackCooldown:96,preyDamage:12,playerAggroRadius:4.5,provokedRadius:38,playerDamage:14,blockedDamage:4,guardStaminaCost:13}},
 eagle:{authored:true,modelHeight:.95,aimHeight:.48,deathRoll:1.16,maxHealth:48,loot:{eagle_meat:1},herd:false,grazes:false,fleeRadius:0,homeRadius:58,wanderSpeed:1.05,escapeSpeed:2.8,turnRate:3.8,
