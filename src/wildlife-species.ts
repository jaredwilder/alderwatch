...
export const WILDLIFE_SPECIES:Record<AnimalKind,WildlifeSpecies>={
 hare:{authored:false,aimHeight:.28,deathRoll:1.18,maxHealth:18,loot:{venison:1},herd:false,grazes:false,fleeRadius:6,homeRadius:8,wanderSpeed:.6,escapeSpeed:3.8,turnRate:4.8},
 crow:{authored:false,aimHeight:.25,deathRoll:1.18,maxHealth:10,loot:{crow_crop:1},herd:false,grazes:false,fleeRadius:6,homeRadius:8,wanderSpeed:.6,escapeSpeed:3.8,turnRate:4.8},
