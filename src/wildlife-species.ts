...
export type AnimalKind='hare'|'rabbit'|'crow'|'goat'|'sheep'|'deer'|'stag'|'boar'|'fox'|'bear'|'bison'|'wolf'|'eagle';
...
export const WILDLIFE_SPECIES:Record<AnimalKind,WildlifeSpecies>={
 hare:{authored:true,legacyFallback:true,modelHeight:.55,aimHeight:.28,deathRoll:1.18,maxHealth:18,loot:{hare_meat:1},rareLoot:{item:'hare_saddle',count:1,oneIn:10},herd:false,grazes:false,fleeRadius:6,homeRadius:8,wanderSpeed:.6,escapeSpeed:3.8,turnRate:4.8},
 rabbit:{authored:true,modelHeight:.45,aimHeight:.23,deathRoll:1.18,maxHealth:14,loot:{hare_meat:1},herd:false,grazes:true,fleeRadius:7,homeRadius:9,wanderSpeed:.68,escapeSpeed:4.1,turnRate:5.4},
 crow:{authored:true,legacyFallback:true,modelHeight:.48,aimHeight:.25,deathRoll:1.18,maxHealth:10,loot:{crow_meat:1,crow_crop:1},rareLoot:{item:'crow_breast',count:1,oneIn:12},herd:false,grazes:false,fleeRadius:6,homeRadius:8,wanderSpeed:.6,escapeSpeed:3.8,turnRate:4.8},
 ...
 stag:{authored:true,modelHeight:1.85,aimHeight:.92,deathRoll:1.18,maxHealth:78,loot:{venison:5,hide:3},rareLoot:{item:'hart_tenderloin',count:1,oneIn:8},herd:false,grazes:true,fleeRadius:13,homeRadius:30,wanderSpeed:.78,escapeSpeed:5.9,turnRate:4.5},
 boar:{authored:true,modelHeight:.95,aimHeight:.58,deathRoll:1.08,maxHealth:110,loot:{hide:2},herd:true,grazes:true,fleeRadius:5.5,homeRadius:24,wanderSpeed:.65,escapeSpeed:4.6,turnRate:4.3},
 fox:{authored:true,modelHeight:.68,aimHeight:.38,deathRoll:1.12,maxHealth:30,loot:{hide:1},herd:false,grazes:false,fleeRadius:10,homeRadius:24,wanderSpeed:.85,escapeSpeed:5.4,turnRate:5.8},
 bear:{authored:true,modelHeight:1.65,aimHeight:1,deathRoll:.72,maxHealth:180,loot:{bear_meat:6,hide:5},rareLoot:{item:'bear_rib',count:1,oneIn:6},herd:false,grazes:false,fleeRadius:0,homeRadius:38,wanderSpeed:.72,escapeSpeed:1.8,turnRate:2.5,predator:{prey:['hare','rabbit','goat','sheep','deer','stag','boar','fox','bison','wolf','eagle'],acquireRadius:25,chaseSpeed:4.1,attackReach:1.75,attackCooldown:72,preyDamage:24,playerAggroRadius:6.5,provokedRadius:34,playerDamage:26,blockedDamage:6,guardStaminaCost:20}},
 ...
 wolf:{authored:true,modelHeight:1.05,aimHeight:.58,deathRoll:1.08,maxHealth:74,loot:{wolf_meat:2,hide:1},rareLoot:{item:'wolf_loin',count:1,oneIn:8},herd:true,grazes:false,fleeRadius:0,homeRadius:34,wanderSpeed:.72,escapeSpeed:5.2,turnRate:5.4,predator:{prey:['hare','rabbit','goat','sheep','deer','stag','boar','fox','bison','eagle'],acquireRadius:42,chaseSpeed:5.35,attackReach:1.55,attackCooldown:96,preyDamage:12,playerAggroRadius:4.5,provokedRadius:38,playerDamage:14,blockedDamage:4,guardStaminaCost:13}},
 eagle:{authored:true,modelHeight:.95,aimHeight:.48,deathRoll:1.16,maxHealth:48,loot:{eagle_meat:1},rareLoot:{item:'eagle_breast',count:1,oneIn:9},herd:false,grazes:false,fleeRadius:0,homeRadius:58,wanderSpeed:1.05,escapeSpeed:2.8,turnRate:3.8,
  aerial:{maxEnergy:80,takeoffEnergy:44,cruiseHeight:7.5,huntHeight:4.8,flightDrainPerSecond:1.05,carryDrainPerSecond:3.2,groundRecoverPerSecond:1.1,carrySeconds:9,pickupPrey:['hare','rabbit','sheep'],killPrey:['crow']},
  predator:{prey:['hare','rabbit','sheep','crow'],acquireRadius:52,chaseSpeed:8.4,attackReach:1.75,attackCooldown:105,preyDamage:12,playerAggroRadius:0,provokedRadius:0,playerDamage:0,blockedDamage:0,guardStaminaCost:0}},
};
...
export const LEGACY_ANIMAL_FALLBACK_SET=new Set<AnimalKind>((Object.keys(WILDLIFE_SPECIES) as AnimalKind[]).filter(kind=>WILDLIFE_SPECIES[kind].legacyFallback));
