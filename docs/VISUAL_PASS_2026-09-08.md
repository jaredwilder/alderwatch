...
Final architectural inspection follow-up: retain the MegaKit's authored PBR atlases rather than repainting them; apply world-metre texture mapping only to bare palette materials, honoring named wood/stone/wall surfaces. Fit the existing authored gables into both open roof ends and raise the misplaced window frame. These are rendering/assembly fixes; collision, interaction and authoritative state remain unchanged. Three additional regressions bring the suite to 344 tests.
